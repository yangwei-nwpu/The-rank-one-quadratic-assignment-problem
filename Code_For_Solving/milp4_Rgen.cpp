...
//char * sol = "C:/Users/wei yang/Desktop/test/test50/QR1-Rgen-L/milp4result/solutionfileQR1-2000-Rgen-L";
int main()
{
...
void solve(int** a, int** b, int** c, int n, int count)
{
	...
	try {
		...
		fprintf(fp, "milp4_gen_total_time：%f  ", execution_time);
		fprintf(fp, "milp4_gen_solve_time：%f total_time_of_A(X)B(X)'s lower and upper：%f ", timey, timex);
